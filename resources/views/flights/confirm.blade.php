                        ...
                        <div class="{{ $currentCard['class'] }} mt-3 mb-4">
                            <div class="d-flex align-items-center">
                                <div class="card-logo-container"
                                    style="padding-right: 15px; border-right: 1px solid #000;">
                                    @if(isset($currentCard['image']))
                                    <img src="{{ asset('assets/images/' . $currentCard['image']) }}"
                                        alt="{{ $currentCard['name'] }}" class="card-logo"
                ...
                <div class="row px-3">
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-3 mb-4 mb-md-0 p-sm-1">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="mb-2"><a href="{{ route('about_us') }}"
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-3 mb-4 mb-md-0 p-sm-1">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-2"><a href="{{ route('important_guideline') }}"
                                    class="text-decoration-none text-muted">Important
                                    Guidelines</a>
                            </li>
                            ...
                            <li class="mb-2"><a href="{{ route('terms_conditions') }}"
                                    class="text-decoration-none text-muted">Terms of service</a>
                            </li>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-3 mb-4 mb-md-0 p-sm-1">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="mb-2"><a href="mailto:" class="text-decoration-none text-muted"><svg
                                        fill="#7042c1" viewBox="0 0 1920 1920" xmlns="https://www.w3.org/2000/svg"
